...
-- ── BRAIN DUMP ───────────────────────────────────
-- Daily release valve. Entries vanish at the member's local midnight (by design).
-- See migration 009 for the hourly pg_cron cleanup that hard-deletes past-day rows.
...
-- ── BRAND WORLDVIEW ──────────────────────────────
-- One record per user: the seven brand belief prompts (Influence section).
...
-- ── BUYING TRIGGERS ──────────────────────────────
-- Many records per user (Influence section).
